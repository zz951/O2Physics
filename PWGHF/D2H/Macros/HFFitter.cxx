...
HFFitter::HFFitter(const TH1F* histoToFit, Double_t minvalue, Double_t maxvalue, Int_t fittypeb, Int_t fittypes) : TNamed(),
                                                                                                                   fHistoInvMass(0x0),
                                                                                                                   fMinMass(minvalue),
                                                                                                                   fMaxMass(maxvalue),
...
void HFFitter::DrawHere(TVirtualPad* c, Int_t writeFitInfo)
{
  ...
  if (writeFitInfo > 0) {
    ...
    if (fRflFunc)
      pinfos->AddText(Form("Refl/Sig =  %.3f #pm %.3f ", fRflOverSig, 0.0));
